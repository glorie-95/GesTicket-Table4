...
<?php include_once('./include/menu.php') ?>
    ...
    margin-top: 80px; background-image:url('../public/img/bj1.jpg');background-repeat: no-repeat;background-size: auto 100%;">  
        <h1 style="position:absolute; margin-left:300px;margin-top:100px;">LISTE DES MENUS CHOISIS</h1>
                ...
                <table style=border:1px;border-collapse;collapse;position:absolute;margin-top:50px;margin-left:-250px;>
                    <thead>
                        <tr>
                            ...
                            <th style="border: 1px solid #000; padding:20px;">Apprenant</th>
                            <th style="border: 1px solid #000; padding:20px;">Plat choisi</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
